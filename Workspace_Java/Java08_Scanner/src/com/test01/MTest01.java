...
public class MTest01 {
	...
	static Scanner sc= new Scanner(System.in); // scanner를 전역변수로 설정해줌 
	...
	public static void test03() {
		//Scanner sc = new Scanner(System.in);
		System.out.println("문자열을 입력해 주세요. (공백 불가)");
	...
	public static void test01() {
		//Scanner sc = new Scanner(System.in); // system.in < cmd 창 안에 입력씨키는 값
